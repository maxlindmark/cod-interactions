...
renv::install("INLA",repos=c(getOption("repos"),INLA="https://inla.r-inla-download.org/R/stable"), dep=TRUE) 
library(INLA)
...
Showing conditional effects of oxygeon on small cod feeding on benthos
...
```{r}
  ...
  ggplot(p, aes(oxygen, exp(est))) + 
    ...
    geom_hline(yintercept = 0.002, col = "red") +

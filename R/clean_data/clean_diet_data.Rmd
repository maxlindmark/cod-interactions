...
cod_save <- cod %>%
  dplyr::select(FR_tot, FR_sad, FR_spr, saduria_entomon_tot, tot_prey_biom, common_tot, unique_pred_id,
                ...
                predfle_density, predcod_density_sc, predfle_density_sc, depth, X, Y, lat, long, ices_rect, cruise)

fle_save <- fle %>%
  dplyr::select(FR_tot, FR_sad, FR_spr, saduria_entomon_tot, tot_prey_biom, common_tot, unique_pred_id,
                year, quarter, pred_weight_g, pred_cm, predator_spec, predcod_density, predfle_density,
                predcod_density_sc, predfle_density_sc, depth, X, Y, lat, long, ices_rect, cruise)

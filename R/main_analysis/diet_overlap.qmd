...
pkgs <- c("tidyverse", "tidylog", "RCurl", "gllvm", "RColorBrewer", "ggrepel", "vegan",
          "patchwork", "RCurl", "devtools")
...
# Source code for rotating ordination plot
...
ordi <- ggplot(dd, aes(x = V1, y = V2, color = group, size = pred_length_cm)) +
